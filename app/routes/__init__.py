"""Routes package — aggregates and registers every route group (pages, auth, game, analysis, rooms) onto the app."""
...
def register_routes(app):
    """Attach all route groups to the Flask app by calling each module's registration function in turn."""
